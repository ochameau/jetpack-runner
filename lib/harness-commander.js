...
exports.buildHarnessOptions = function (packages, targetPackageName, additionalPackagesToInclude) {
  function S4() {
  ...
  function declareOneModule(pack,dir,module) {
    ...
    var resourcePath = "resource://"+prefix+"-"+pack+"-"+dir+"/"+module.path.join("/")+(module.path.length>0?"/":"")+module.name;
  ...
  function includePackage(name, requiredBy) {
    ...
    function registerOneResourcesDir(dir, dirType) {
      var resourceId = prefix+"-"+p.name+"-"+dir;
  ...
  includePackage(targetPackageName);
...
exports.launchTest = function (options) {
  let harnessOptions = exports.buildHarnessOptions(
    options.packages, 
...
exports.launchMain = function (options) {
  let harnessOptions = exports.buildHarnessOptions(options.packages, 
    options.package.name);
...
exports.buildStandaloneApplication = function (packages, package, zipfile) {
  let options = exports.buildHarnessOptions(packages, package.name);
  
  options.main  = "main";
  options.verbose = true;
  
  let templatePath = require("url").toFilename(require("self").data.url("addon-runner@mozilla.com"));
