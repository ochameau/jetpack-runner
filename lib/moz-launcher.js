...
exports.launch = process.env.ComSpec ? launchMozBinaryWin32 : launchMozBinary;
// There is two issues on Windows:
// 1/ dump() in remote instance do not work but nsIDomWindow.dump is working 
// correctly. This has been fixed in addon code.
// 2/ windows are broken when using regular process execution.
// if we launch firefox with "-jsconsole", main browser window appear,
// but if we launch it without particular option, no window appear!
